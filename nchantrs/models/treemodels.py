...
class NchantdFileSystemModel(pyqt.QFileSystemModel):
    ...
    def buildNodes(self) -> None:
        logma.info(f'buildNodes called')
        return self
...
class NchantdTreeModel(pyqt.QStandardItemModel):
    ...
    def __init__(self, parent=None, root=None, cfg=None) -> None:
        ...
        self.nodecolumns = [x['name'] for x in self.config.dikt['dstruct']['database']['objects']['table']['app_tree_node']['columns']]
    ...
    def create_objects(self, objects) -> None:
        ...
        app_objects = {'table': {'app_tree_node': {'records': objects['table']['app_tree_node']['records'], 'columns': objects['table']['app_tree_node']['columns']}}, 'view': self.config.dikt['dstruct']['database']['objects'].get('view', {})}
    ...
    def create_objects_instance(self, objects, db='db') -> None:
        ...
        doc_objects = {'table': {'doc_tree_node': {'records': objects['table']['doc_tree_node']['records'], 'columns': objects['table']['doc_tree_node']['columns']}}}
    ...
    def add_node_set(self) -> None:
        logma.info(f'add_node_set called')
        return self
    ...
    def updateStatus(self, status) -> None:
        logma.info(f'updateStatus called')
        return self
...
class NchantdTimeTreeModel(NchantdApplicationTreeModel):
    ...
    def addCenturyNode(self) -> None:
        logma.info(f'addCenturyNode called')
        return self

    def addDayNode(self) -> None:
        logma.info(f'addDayNode called')
        return self

    def addDecadeNode(self) -> None:
        logma.info(f'addDecadeNode called')
        return self

    def addHourNode(self) -> None:
        logma.info(f'addHourNode called')
        return self

    def addMinuteNode(self) -> None:
        logma.info(f'addMinuteNode called')
        return self

    def addMonthNode(self) -> None:
        logma.info(f'addMonthNode called')
        return self

    def addWeekNode(self) -> None:
        logma.info(f'addWeekNode called')
        return self
    ...
    def define_structure(self, structure) -> None:
        logma.info(f'define_structure called')
        return self
