...
def getAlignment(justify: str) -> int:
    ...
    Returns:
        Qt alignment flag
    """
    ALIGNMENT_MAP = {'left': pyqt.Qt.AlignmentFlag.AlignLeft, 'center': pyqt.Qt.AlignmentFlag.AlignCenter, 'right': pyqt.Qt.AlignmentFlag.AlignRight, 'top': pyqt.Qt.AlignmentFlag.AlignTop, 'bottom': pyqt.Qt.AlignmentFlag.AlignBottom, 'top_left': pyqt.Qt.AlignmentFlag.AlignTop | pyqt.Qt.AlignmentFlag.AlignLeft}
