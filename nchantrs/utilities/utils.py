...
def search(action: str, gcfg: dict, deep: bool=False, debug: bool=True) -> dict:
    ...
    return {'name_txt': None, 'description_ltxt': None, 'UUID': None, 'icon_txt': None, 'shortcut_txt': None, 'tip_txt': None, 'advanced_tip_txt': None, 'widget_txt': None, 'params_dict': None}
