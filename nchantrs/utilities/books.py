...
def convert_cherrytree_2_nchantdbook(path, name=None, import_=False) -> None:
    ...
    raise NotImplementedError(
        "convert_cherrytree_2_nchantdbook lives in nchantdoffice; "
        "nchantrs does not depend on pyffice."
    )
...
def convert_filesystem_2_nchantdbook(path, name=None, import_=False) -> None:
    ...
    """
    raise NotImplementedError(
        "convert_filesystem_2_nchantdbook lives in nchantdoffice; "
        "nchantrs does not depend on pyffice."
    )
...
def convert_excel_2_nchantdmatrix(path, name=None) -> None:
    ...
    """
    raise NotImplementedError(
        "convert_excel_2_nchantdmatrix lives in nchantdoffice; "
        "nchantrs does not depend on pyffice."
    )
...
def convert_word_2_nchantdscript(path, name=None) -> None:
    ...
    """
    raise NotImplementedError(
        "convert_word_2_nchantdscript lives in nchantdoffice; "
        "nchantrs does not depend on pyffice."
    )
