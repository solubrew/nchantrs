...
<(META)>:  #															||
	...
	name:	#														||
	description: >  #													||
		Create a basic messaging service using the wormhole functionality
...
log = True
#=======================================================================||
pxcfg = f'{here}_data_/nchantdtodos.yaml'
class NchantdScribe(NchantdCloak):
	''' '''
	def __init__(self, args, parent=None):
		...
		super(NchantdScribe, self).__init__('NchantdScribe', self)
