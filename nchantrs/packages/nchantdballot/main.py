...
<(META)>:  #																	||
	...
	name: Nchantd Ballot  #														||
	description: >  #															||
		Nchantd Ballot is a standardized application for aggregating web3
		voting across protocols by using apis and signatures to record the
		users votes to the appropriate protocol
	expirary: <[expiration]>  #											||
	version: <[version]>  #												||
	path: <[LEXIvrs]>  #												||
	outline: <[outline]>  #												||
...
log = True
#=======================================================================||
pxcfg = f'{here}_data_/nchantdballot.yaml'
class NchantdBallot(NchantdCloak):
	''' '''
	def __init__(self, args, parent=None):
		...
		super(NchantdBallot, self).__init__('NchantdBallot', self)
