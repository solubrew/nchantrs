...
class NchantdGameBoard(NchantdWidget):
        ...
        with QPainter(self) as painter:
            ...
            if self._cur_piece.shape() != Piece.NoShape:
                for i in range(4):
                    ...
                    self.draw_square(painter, rect.left() + x * self.square_width(), board_top + (TetrixBoard.board_height - y - 1) * self.square_height(), self._cur_piece.shape())
    ...
    def draw_square(self, painter, x, y, shape) -> None:
        color_table = [0, 13395558, 6736998, 6710988, 13421670, 13395660, 6737100, 14330368]
