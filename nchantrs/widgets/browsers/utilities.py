...
def nchantd_message_handler(mode, context, message) -> None:
    ...
    mode_name = {pyqt.Qt.InfoMsg: 'Info', pyqt.Qt.WarningMsg: 'Warning', pyqt.Qt.CriticalMsg: 'Critical', pyqt.Qt.DebugMsg: 'Debug'}
    logger.info(f'{mode_name[mode]}: {message} (File: {context.file}, Line: {context.line})')

def set_default_browser(browser_name='google-chrome', browser_path='', browser_exe_path='', browser_bundle_id='com.google.Chrome') -> None:
    """"""
