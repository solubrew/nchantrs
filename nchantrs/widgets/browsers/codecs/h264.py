...
class OpenH264Downloader:
    ...
    def _get_app_data_dir(self) -> str:
        ...
        if system == 'windows':
            return expandvars(f'%APPDATA%\\{self.app_name}')
        elif system == 'darwin':
...
class OpenH264Manager:
    ...
    def _setup_linux_integration(self, library_path: str) -> None:
        ...
        try:
            gst_plugin_dirs = [Path.home() / '.cache' / 'gstreamer-1.0', Path('/usr/lib/x86_64-linux-gnu/gstreamer-1.0'), Path('/usr/local/lib/gstreamer-1.0')]
