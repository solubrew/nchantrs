...
class ServiceDiscovery(pyqt.QObject):
    ...
    serviceStatusChanged = pyqt.Signal(str, ServiceStatus)
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.framework_signatures = {'React Dev Server': [3000, 3001], 'Vue Dev Server': [8080, 8081], 'Vite Dev Server': [5173], 'Django Dev Server': [8000], 'Flask Dev Server': [5000], 'Express Server': [3000, 8000], 'Webpack Dev Server': [8080], 'Next.js Dev Server': [3000], 'Jupyter Notebook': [8888], 'Streamlit': [8501]}
