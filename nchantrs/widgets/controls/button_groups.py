...
class NchantdButtonGrid(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        ...
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdButtonGrid").override(cfg))
...
class NchantdAcceptButtons(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdAcceptButtons").override(cfg))
        self.ok_button = None
...
class NchantdOkButtons(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdOkButtons").override(cfg))
        self.ok_button = None
        self.cancel_button = None
...
class NchantdSaveButtons(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdSaveButtons").override(cfg))
        self.newbutton = None
...
class NchantdSubmissionButtons(NchantdWidget):
    """A single pane widget with a button set for submitting a form"""

    def __init__(self, parent=None, cfg={}) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdSubmissionButtons").override(cfg))
...
class NchantdTabSideButtons(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdTabSideButtons").override(cfg))
...
class NchantdMathPad(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdMathPad").override(cfg))
...
class NchantdNumberPad(pyqt.QWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdNumberPad").override(cfg))
...
class NchantdFontConfigBar(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdFontConfigBar").override(cfg))
...
class NchantdBorderConfigBar(NchantdWidget):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdBorderConfigBar").override(cfg))
        self.can_highlight = None
