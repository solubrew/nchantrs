...
class NchantdCheckbox(NchantdWidgetMixin, pyqt.QCheckBox):
    ...
    def set_size(self, set_width: Optional[int]=None, set_height: Optional[int]=None, min_width: int=DEFAULT_MIN_DIMENSION, min_height: int=DEFAULT_MIN_DIMENSION, max_width: Optional[int]=None, max_height: Optional[int]=None) -> None:
        """"""
