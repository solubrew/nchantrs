...
class NchantdApplicationStartupWizard(NchantdWizard):
    ...
    def initModel(self, args=None) -> Any:
        ...
        if self.app.is_installable is True:
    ...
    def create_shortcut(self) -> Any:
        ...
        if self.os_type == "linux":
            ...
            with open(self.shortcut_path, "w") as desktop_file:
                data = {
            ...
            lnk = Lnk()
            lnk.path = self.application_path
            lnk.description = f"Shortcut for {self.slug}"
    ...
    def run_application_install(self, paths) -> Any:
        ...
        self.initialize_application()  # need to break out the policy, user and instance from application
    ...
    def set_library_status(self) -> Any:
        ...
        if is_pro:
            ...
            self.library_path = (
                join(self.app.model.application_path, "library")
                if hasattr(self, "app") and hasattr(self.app, "model")
                else "."
            )
...
class NchantdApplicationSetupDetailsPage(NchantdWizardPage):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        ...
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdApplicationSetupDetailsPage").override(cfg))
    ...
    def initView(self) -> Any:
        ...
        self.application_name.setPlaceholderText(self.parent.app.application_name)
...
class NchantdApplicationConfigurationPage(NchantdWizardPage):
    ...
    def __init__(self, parent=None, cfg=None) -> None:
        """ """
        super().__init__(parent, cfg)
        self.config.override(kahndor.Instruct(pxcfg).select("NchantdApplicationConfigurationPage").override(cfg))
    ...
    def initView(self, cfg=None) -> Any:
        ...
        cfg = {"text": "Select Data Storage Method", "options": ["Nchantd Library", "In-Place File System"]}
