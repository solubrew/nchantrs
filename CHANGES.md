...
- Add CLI module with commands for all modules (51763b5, 5500727, 4fb9343, 7462b89)
- Add __main__.py entry point (51763b5, 5500727)
- Add nchantrs.yaml configuration file (51763b5)
- Add config/nchantrs.yaml (4fb9343)
- Add CONTRIBUTING.md (51763b5)
- Add .github/workflows/ci.yml (51763b5)
- Add CLI.md documentation (5500727)
- Add pyright and mypy configuration (b64d08e)
- Add isort configuration (51763b5)
- Move traceback imports to top-level (e5640b4, 29e5f26, 74ceb58)
- Rename password variable to pword for pii_secrets (29e5f26)
