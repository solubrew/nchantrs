"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.physician.physicians_reference.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "physician", "physicians_reference.py")
