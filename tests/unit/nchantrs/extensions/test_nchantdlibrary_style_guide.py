"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.style_guide.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "style_guide.py")
