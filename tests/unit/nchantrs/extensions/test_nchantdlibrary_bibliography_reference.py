"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.bibliography_reference.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "bibliography_reference.py")
