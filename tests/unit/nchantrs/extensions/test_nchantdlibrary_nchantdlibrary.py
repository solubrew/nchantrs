"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.nchantdlibrary.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "nchantdlibrary.py")
