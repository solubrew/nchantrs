"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.thesaurus.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "thesaurus.py")
