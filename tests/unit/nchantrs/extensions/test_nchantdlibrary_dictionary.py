"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.dictionary.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "dictionary.py")
