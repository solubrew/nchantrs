"""Source-structure tests for nchantrs.extensions.packages.nchantdlibrary.games.gameoflife.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("extensions", "packages", "nchantdlibrary", "games", "gameoflife.py")
