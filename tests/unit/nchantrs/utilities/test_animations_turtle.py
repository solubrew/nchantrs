"""Source-structure tests for nchantrs.utilities.graphics.animations.turtle.
...
MODULE_PATH = PROJECT_ROOT / "nchantrs" / Path("utilities", "graphics", "animations", "turtle.py")
